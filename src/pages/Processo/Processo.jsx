    ...
    <>
      ...
      <S.ContainerGeral>
        ...
        <S.ContainerProcess>
          ...
          <S.ContainerInfoProcesso>
            <S.NumberProcess>{processo?.numeroProcesso}</S.NumberProcess>
            <CardProcesso
              processStatus={processo?.status}
              processType={processo?.tipoProcesso}
              initialDate={processo?.dataInicio}
              clientName={processo?.cliente.nome}
              processoId={processo?.id}
            />
          </S.ContainerInfoProcesso>
          <S.ContainerDocumentos>
            <S.TitleContainerDocuments>Documentos</S.TitleContainerDocuments>
            <S.SectionDocuments></S.SectionDocuments>
          </S.ContainerDocumentos>
        </S.ContainerProcess>
      </S.ContainerGeral>
    </>
